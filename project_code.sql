...
--A table with the total number of casual riders
CREATE TABLE total_casual(
	casual nvarchar(max),
)

INSERT INTO total_casual(
	casual
)
...
--A table with total number of member riders
CREATE TABLE total_member(
	member nvarchar(max),
)

INSERT INTO total_member(
	member
)
